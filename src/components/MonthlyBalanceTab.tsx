  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-8">
          ...
          <div className="flex items-center justify-between pb-4 border-b border-slate-100 mb-5">
            ...
            {onCopyMonthContas && (
              <button
                ...
                className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold transition-all border border-slate-200/80"
            ...
            <div className={`p-5 rounded-2xl border transition-all ${
              ...
              <div className="flex items-center justify-between pb-3 border-b border-slate-200/60">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm">Setembro de 2026</h4>
                    <span className="text-[11px] text-slate-500">{setMonth.txCount} contas e transações</span>
                  </div>
                </div>
                <button
                  onClick={() => {
                  ...
                  className="px-3 py-1.5 text-xs font-bold rounded-xl bg-white hover:bg-emerald-600 hover:text-white text-emerald-800 border border-emerald-200 transition-all flex items-center gap-1 shadow-2xs"
                >
              ...
              <div className="grid grid-cols-3 gap-2 mt-4 text-center">
                <div className="p-2.5 bg-white rounded-xl border border-slate-100">
                  <span className="text-[10px] font-bold text-emerald-700 block">Renda</span>
                  <span className="text-xs sm:text-sm font-black text-slate-900">{formatCurrency(setMonth.income)}</span>
                </div>
                <div className="p-2.5 bg-white rounded-xl border border-slate-100">
                  <span className="text-[10px] font-bold text-rose-700 block">Despesas</span>
                  <span className="text-xs sm:text-sm font-black text-slate-900">{formatCurrency(setMonth.expenses)}</span>
                  <span className="text-[10px] text-slate-400 block">{setMonth.expenseRate.toFixed(0)}% da renda</span>
                </div>
                <div className="p-2.5 bg-white rounded-xl border border-slate-100">
                  <span className="text-[10px] font-bold text-indigo-700 block">Investido</span>
                  <span className="text-xs sm:text-sm font-black text-indigo-900">{formatCurrency(setMonth.investments)}</span>
                  <span className="text-[10px] text-indigo-500 block">{setMonth.savingsRate.toFixed(0)}% aporte</span>
                </div>
              </div>

              <div className="mt-3 pt-3 border-t border-slate-200/60 flex items-center justify-between">
                <span className="text-xs font-bold text-slate-700">Sobra Livre do Mês:</span>
                <span className={`text-sm font-black ${setMonth.surplus >= 0 ? 'text-emerald-700' : 'text-rose-600'}`}>
            ...
            <div className={`p-5 rounded-2xl border transition-all ${
              ...
              <div className="flex items-center justify-between pb-3 border-b border-slate-200/60">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm">Outubro de 2026</h4>
                    <span className="text-[11px] text-slate-500">{outMonth.txCount} contas e transações</span>
                  </div>
                </div>
                <button
                  onClick={() => {
                  ...
                  className="px-3 py-1.5 text-xs font-bold rounded-xl bg-white hover:bg-indigo-600 hover:text-white text-indigo-800 border border-indigo-200 transition-all flex items-center gap-1 shadow-2xs"
                >
                  <span>Abrir Contas</span>
                  <ArrowRight className="w-3 h-3" />
                </button>
              ...
              <div className="grid grid-cols-3 gap-2 mt-4 text-center">
                <div className="p-2.5 bg-white rounded-xl border border-slate-100">
                  <span className="text-[10px] font-bold text-emerald-700 block">Renda</span>
                  <span className="text-xs sm:text-sm font-black text-slate-900">{formatCurrency(outMonth.income)}</span>
                </div>
                <div className="p-2.5 bg-white rounded-xl border border-slate-100">
                  <span className="text-[10px] font-bold text-rose-700 block">Despesas</span>
                  <span className="text-xs sm:text-sm font-black text-slate-900">{formatCurrency(outMonth.expenses)}</span>
                  <span className="text-[10px] text-slate-400 block">{outMonth.expenseRate.toFixed(0)}% da renda</span>
                </div>
                <div className="p-2.5 bg-white rounded-xl border border-slate-100">
                  <span className="text-[10px] font-bold text-indigo-700 block">Investido</span>
                  <span className="text-xs sm:text-sm font-black text-indigo-900">{formatCurrency(outMonth.investments)}</span>
                  <span className="text-[10px] text-indigo-500 block">{outMonth.savingsRate.toFixed(0)}% aporte</span>
                </div>
              </div>

              <div className="mt-3 pt-3 border-t border-slate-200/60 flex items-center justify-between">
                <span className="text-xs font-bold text-slate-700">Sobra Livre do Mês:</span>
                <span className={`text-sm font-black ${outMonth.surplus >= 0 ? 'text-emerald-700' : 'text-rose-600'}`}>
      ...
      <div 
        ...
        className="bg-slate-50/90 rounded-3xl p-5 sm:p-7 border border-slate-200/90 space-y-5"
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-200/80">
          ...
          <span className="text-xs font-bold text-emerald-800 bg-emerald-100/90 px-3 py-1.5 rounded-xl self-start sm:self-auto flex items-center gap-1.5 border border-emerald-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
          ...
          <div 
            ...
            className="bg-white rounded-2xl p-4 border border-emerald-200 shadow-2xs cursor-pointer hover:border-emerald-400 hover:shadow-md transition-all group flex flex-col justify-between"
            role="button"
            tabIndex={0}
          ...
          >
            <div>
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-extrabold tracking-wider text-emerald-800">
                  1. Renda Principal
                </span>
            ...
            <div className="mt-2.5 pt-2 border-t border-emerald-100/80 flex items-center justify-between text-[11px] font-bold text-emerald-700 group-hover:text-emerald-900 transition-colors">
          ...
          <div 
            ...
            className="bg-white rounded-2xl p-4 border border-rose-200 shadow-2xs cursor-pointer hover:border-rose-400 hover:shadow-md transition-all group flex flex-col justify-between"
            role="button"
            tabIndex={0}
          ...
          >
            <div>
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-extrabold tracking-wider text-rose-800">
                  2. Despesas
                </span>
            ...
            <div className="mt-2.5 pt-2 border-t border-rose-100/80 flex items-center justify-between text-[11px] font-bold text-rose-700 group-hover:text-rose-900 transition-colors">
              <span>Ver Ranking</span>
              <span className="flex items-center gap-0.5">Maiores →</span>
            </div>
          </div>
          ...
          <div 
            ...
            className="bg-white rounded-2xl p-4 border border-indigo-200 shadow-2xs cursor-pointer hover:border-indigo-400 hover:shadow-md transition-all group flex flex-col justify-between"
            role="button"
            tabIndex={0}
          ...
          >
            <div>
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-extrabold tracking-wider text-indigo-800">
                  3. Investimentos
                </span>
            ...
            <div className="mt-2.5 pt-2 border-t border-indigo-100/80 flex items-center justify-between text-[11px] font-bold text-indigo-700 group-hover:text-indigo-900 transition-colors">
              <span>Ver Ranking</span>
              <span className="flex items-center gap-0.5">Maiores →</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 border border-sky-200 shadow-2xs flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-extrabold tracking-wider text-sky-800">
                  4. Sobra Livre
                </span>
              ...
              <div className="mt-2">
                <div className={`text-xl sm:text-2xl font-black tracking-tight ${activeSurplus < 0 ? 'text-rose-600' : 'text-slate-900'}`}>
            ...
            <div className="mt-2.5 pt-2 border-t border-sky-100/80 text-[11px] font-bold text-sky-700">
        ...
        {/* Diagnóstico */}
        <div className="p-3.5 bg-white rounded-2xl border border-slate-200 text-xs text-slate-600 flex items-center gap-2">
      ...
      <div className="bg-white rounded-3xl p-5 sm:p-7 border border-slate-200/90 shadow-sm">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs sm:text-sm">
            <thead>
              <tr className="border-b border-slate-200 text-slate-500 text-[11px] font-extrabold tracking-wider bg-slate-50/70">
            ...
            <tbody className="divide-y divide-slate-100">
              {monthsData.map((m) => {
                ...
                return (
                  <tr 
                    key={m.key} 
                    className={`transition-colors hover:bg-slate-50/80 ${isCurrent ? 'bg-emerald-50/40 font-semibold' : ''}`}
                  >
                    <td className="py-3.5 px-3.5 font-bold text-slate-900 flex items-center gap-2">
                      <div className={`w-2.5 h-2.5 rounded-full ${isCurrent ? 'bg-emerald-600' : 'bg-slate-300'}`} />
                      <span>{m.name}</span>
                      {isCurrent && (
                    ...
                    <td className="py-3.5 px-3 text-right font-extrabold">
                      <span className={m.surplus >= 0 ? 'text-emerald-700' : 'text-rose-600'}>
      ...
      <div className="bg-white rounded-3xl p-5 sm:p-7 border border-slate-200/90 shadow-sm">
        ...
        <div className="space-y-5">
          {monthsData.map((m) => {
            ...
            return (
              <div key={m.key} className="p-3 bg-slate-50/80 rounded-2xl border border-slate-200/60">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-bold text-xs sm:text-sm text-slate-900">
                    {m.name}
                  </span>
                  <div className="flex items-center gap-3 text-[11px] font-bold">
                    <span className="text-emerald-700">Renda: {formatCurrency(m.income)}</span>
                    <span className="text-rose-700">Gastos: {formatCurrency(m.expenses)}</span>
                    <span className="text-indigo-700">Investido: {formatCurrency(m.investments)}</span>
                  </div>
                </div>
        ...
        {/* Legend */}
        <div className="flex items-center justify-center gap-6 mt-5 pt-3 border-t border-slate-100 text-xs font-semibold text-slate-600">
      ...
      {rankingModalType && (
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-in fade-in duration-150">
          <div className="bg-white rounded-3xl max-w-lg w-full p-5 sm:p-6 shadow-xl border border-slate-200 space-y-4 max-h-[85vh] flex flex-col">
